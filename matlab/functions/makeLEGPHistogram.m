...
addpath('C:\Users\Mitchell\Documents\MATLAB') 
%% Fridge Demand 
dates = MaliNTS(:,1:4);
...
colormap hot
set(ax(1),'FontSize',12,'YLim',[0 .4],'XLim', [0 25],'YTick',0:0.1:0.4)
set(ax(2),'FontSize',12,'XLim', [0 25],'YTick',0:100:400)
set(h2,'LineWidth',2,'LineStyle','--')
legend('Hourly LEGP for Yearly LEGP = 0.01','Hourly LEGP for Yearly LEGP = 0.03', 'Hourly LEGP for Yearly LEGP = 0.05','Micro-Grid Demand (W-hr)')%\
h_legend=legend;
set(h_legend,'FontSize',10);

%% Make a Map of Energy Shortfall
figure
makeLEGMap( LEG1(:,1), 5089:5832);
