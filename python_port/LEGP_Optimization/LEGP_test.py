...
demVec = mat2['fridgeDemandYearSyn']
demVec = demVec[:,0]
LEGPVec = [0.05]
lats = 13.45
weathVec = data[:,4]
...
batcap, desired = legp.batCapCal(dates, 13.45, resource, demVec, 1000000, 0.05, 100,
100)
...
(batchar, LEG, LEGP) = legp.SuppDemSum(dates, 13.45, I_C, demVec, 2000, 10000, 5000)
'''
